...
namespace Banty.Security
{
	...
	public class MD5Crypt
	{
		...
		/// <param name="useHashing">Whether hashing is used</param>
		...
		public static string Encrypt(string toEncrypt, string securityKey, bool useHashing)
		{
			...
			try
			{
				...
				// Validate inputs
//				NGUIDebug.Log ("toEncrypt = "+toEncrypt);
//				NGUIDebug.Log ("securityKey = "+securityKey);
		...
		{
//			NGUIDebug.Log ("inputValue = "+inputValue);
			return true;

...
public class SmartIAPListener : MonoBehaviour {
	...
	void OnPurchaseCompleted(SmartIAPReceipt receipt)
	{
		...
		/// Your code here...
		//Shivam
		Debug.Log("Hurrey Purchase done, Gems Successfully added "+newShop._instance.No_Of_Gems );
		if (newShop._instance.No_Of_Gems == 100) {
			PlayerParameters._instance.myPlayerParameter.gems += 100;
		} else if (newShop._instance.No_Of_Gems == 280) {
			PlayerParameters._instance.myPlayerParameter.gems += 280;
		} else if (newShop._instance.No_Of_Gems == 570) {
			PlayerParameters._instance.myPlayerParameter.gems += 570;
		} else if (newShop._instance.No_Of_Gems == 1250) {
			PlayerParameters._instance.myPlayerParameter.gems += 1250;
		} else if (newShop._instance.No_Of_Gems == 2450) {
			PlayerParameters._instance.myPlayerParameter.gems += 1250;
		} else if (newShop._instance.No_Of_Gems == 5500) {
			PlayerParameters._instance.myPlayerParameter.gems += 1250;
		} else if (newShop._instance.No_Of_Gems == 12000) {
			PlayerParameters._instance.myPlayerParameter.gems += 12000;
		} else {
		}
		...
		Debug.Log("Gems Updated on Server Successfully");
		newShop._instance.purchaseGemsExit ();
	}	
